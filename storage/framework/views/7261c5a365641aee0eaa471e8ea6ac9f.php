...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>"
                        class="block w-full rounded-lg border-2 border-gray-300 bg-white px-4 py-2.5 text-gray-900 shadow-sm focus:ring-2 focus:border-transparent transition-all <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="country" id="country" value="<?php echo e(old('country', 'Guinée')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gdevis\resources\views/clients/create.blade.php ENDPATH**/ ?>