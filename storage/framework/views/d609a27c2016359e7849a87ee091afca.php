...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <option value="barre" <?php echo e(old('unite', $material->unite) == 'barre' ? 'selected' : ''); ?>>barre</option>
                    <option value="m" <?php echo e(old('unite', $material->unite) == 'm' ? 'selected' : ''); ?>>m (mètre)</option>
                    <option value="Paire" <?php echo e(old('unite', $material->unite) == 'Paire' ? 'selected' : ''); ?>>Paire</option>
                    <option value="unité" <?php echo e(old('unite', $material->unite) == 'unité' ? 'selected' : ''); ?>>unité</option>
                    <option value="feuille" <?php echo e(old('unite', $material->unite) == 'feuille' ? 'selected' : ''); ?>>feuille</option>
                    <option value="rouleau" <?php echo e(old('unite', $material->unite) == 'rouleau' ? 'selected' : ''); ?>>rouleau</option>
                    <option value="kg" <?php echo e(old('unite', $material->unite) == 'kg' ? 'selected' : ''); ?>>kg (kilogramme)</option>
                    <option value="__custom__">Autre (saisie libre)</option>
                </select>
                <input type="text" name="unite_custom" id="unite_custom" value="<?php echo e(old('unite', $material->unite)); ?>" 
                    class="hidden mt-2 block w-full rounded-lg border-2 border-gray-400 bg-white px-4 py-3 text-gray-900 text-base shadow-sm focus:ring-2 focus:border-transparent transition-all <?php $__errorArgs = ['unite'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const currentUnite = '<?php echo e(old('unite', $material->unite)); ?>';
