            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="table-row-hover">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                        <i class="fas fa-envelope mr-2 text-gray-400"></i><?php echo e($user->email); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 hidden md:table-cell">
                        <i class="fas fa-calendar-alt mr-2 text-gray-400"></i><?php echo e($user->created_at->format('d/m/Y')); ?>
                        ...
                        <?php if($user->valid_until): ?>
                            ...
                            <?php elseif($user->valid_until->diffInDays(now()) <= 7): ?>
                                <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-lg bg-yellow-100 text-yellow-800 border border-yellow-200">
                                    <i class="fas fa-clock mr-1"></i><?php echo e($user->valid_until->format('d/m/Y')); ?>
                            ...
                            <?php else: ?>
                                <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-lg bg-green-100 text-green-800 border border-green-200">
                                    <i class="fas fa-check-circle mr-1"></i><?php echo e($user->valid_until->format('d/m/Y')); ?>
                    ...
                    <td colspan="6" class="px-6 py-16 text-center">
                        <div class="text-gray-400">
                            <div class="inline-flex items-center justify-center w-20 h-20 rounded-full mb-4"
                                ...
                                <i class="fas fa-users-cog text-4xl" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;"></i>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gdevis\resources\views/users/index.blade.php ENDPATH**/ ?>