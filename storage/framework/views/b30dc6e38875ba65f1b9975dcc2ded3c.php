    ...
    <style>
        ...
        * {
        ...
        .product-header {
            ...
            color: <?php echo e($headerColor); ?> !important;
            font-weight: bold;
    ...
    <div class="content-wrapper">
        ...
        <table class="product-table">
            <tfoot>
                ...
                <tr class="total-row" style="background-color: <?php echo e($headerColor); ?> !important; border-top: 3px solid <?php echo e($headerColor); ?>;">
                    <td><strong style="color: <?php echo e($textColor); ?>;">MONTANT FINAL s'accorder</strong></td>
                    <td></td>
                    <td><strong style="color: <?php echo e($textColor); ?>;">-</strong></td>
                    <td><strong style="color: <?php echo e($textColor); ?>;">-</strong></td>
                    <td><strong style="color: <?php echo e($textColor); ?>;">-</strong></td>
                    <td><strong style="color: <?php echo e($textColor); ?>; font-size: 1.2em;"><?php echo e(number_format($quote->final_amount, 0, ',', ' ')); ?> GNF</strong></td>
                </tr>
                <?php else: ?>
                <tr class="total-row">
