    ...
    <div class="card-modern overflow-hidden">
        ...
        <div class="p-6">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 rounded-xl border border-blue-100">
                    ...
                    <dl class="space-y-3">
                        <div class="flex items-center">
                            ...
                            <dd class="text-sm font-bold text-gray-900"><?php echo e($user->name); ?></dd>
                        </div>
                        <div class="flex items-center">
                            <dt class="text-sm font-semibold text-gray-600 w-24">Email:</dt>
                            <dd class="text-sm text-gray-900"><i class="fas fa-envelope mr-2 text-gray-400"></i><?php echo e($user->email); ?></dd>
                        </div>
                    </dl>
                </div>
                <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-5 rounded-xl border border-purple-100">
                    ...
                    <dl class="space-y-3">
                        <div class="flex items-center">
                            ...
                            <dd class="text-sm">
                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-lg shadow-sm
                                    <?php if($user->role === 'admin'): ?> bg-purple-100 text-purple-800 border border-purple-200
                                ...
                                <?php if($user->valid_until): ?>
                                    <?php if($user->isExpired()): ?>
                                        <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-lg shadow-sm bg-red-100 text-red-800 border border-red-200">
                                            <i class="fas fa-exclamation-triangle mr-1"></i>Expiré le <?php echo e($user->valid_until->format('d/m/Y')); ?>

                                        </span>
                                    <?php elseif($user->valid_until->diffInDays(now()) <= 7): ?>
                                        <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-lg shadow-sm bg-yellow-100 text-yellow-800 border border-yellow-200">
                                            <i class="fas fa-clock mr-1"></i>Expire le <?php echo e($user->valid_until->format('d/m/Y')); ?>
                                    ...
                                    <?php else: ?>
                                        <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-lg shadow-sm bg-green-100 text-green-800 border border-green-200">
                                            <i class="fas fa-check-circle mr-1"></i>Valide jusqu'au <?php echo e($user->valid_until->format('d/m/Y')); ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <dd class="text-sm text-gray-900"><i class="fas fa-calendar-alt mr-2 text-gray-400"></i><?php echo e($user->created_at->format('d/m/Y à H:i')); ?></dd>
                        </div>
                        <div class="flex items-center">
                            <dt class="text-sm font-semibold text-gray-600 w-32">Modifié le:</dt>
                            <dd class="text-sm text-gray-900"><i class="fas fa-calendar-check mr-2 text-gray-400"></i><?php echo e($user->updated_at->format('d/m/Y à H:i')); ?></dd>
                        </div>
                    </dl>
                </div>
            </div>
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                ...
                <?php elseif($user->permissions->count() > 0): ?>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                        <?php $__currentLoopData = $user->permissions->groupBy('category'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $categoryPermissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border border-gray-200 rounded-lg p-4">
                                <h4 class="font-medium text-gray-900 mb-2 capitalize text-sm"><?php echo e($category); ?></h4>
                                <ul class="space-y-1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gdevis\resources\views/users/show.blade.php ENDPATH**/ ?>