...
<?php $__env->startSection('title', 'Détails Chantier'); ?>
...
<div class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                <div>
                    <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 flex items-center">
                        ...
                        Chantier <?php echo e($chantier->chantier_number); ?>

                    </h2>
                    <p class="mt-2 text-sm text-gray-600">
                        Devis: <a href="<?php echo e(route('quotes.show', $chantier->quote)); ?>" class="text-blue-600 hover:underline"><?php echo e($chantier->quote->quote_number); ?></a> | 
                        Client: <?php echo e($chantier->quote->client->name); ?>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white border-2 rounded-lg p-4">
                    ...
                    <form method="POST" action="<?php echo e(route('chantiers.update-status', $chantier)); ?>" class="mb-2">
                        <?php echo csrf_field(); ?>
                        <select name="status" onchange="this.form.submit()" 
                                class="block w-full rounded-lg border-2 border-gray-300 bg-white px-3 py-2 text-sm">
                            <option value="planifié" <?php echo e($chantier->status == 'planifié' ? 'selected' : ''); ?>>Planifié</option>
                            <option value="en_cours" <?php echo e($chantier->status == 'en_cours' ? 'selected' : ''); ?>>En cours</option>
                            <option value="suspendu" <?php echo e($chantier->status == 'suspendu' ? 'selected' : ''); ?>>Suspendu</option>
                            <option value="terminé" <?php echo e($chantier->status == 'terminé' ? 'selected' : ''); ?>>Terminé</option>
                            <option value="facturé" <?php echo e($chantier->status == 'facturé' ? 'selected' : ''); ?>>Facturé</option>
                        </select>
                    </form>
                </div>
                ...
                <div class="bg-white border-2 rounded-lg p-4">
                    ...
                    <form method="POST" action="<?php echo e(route('chantiers.update-progress', $chantier)); ?>" class="mb-2">
                        <?php echo csrf_field(); ?>
                        <div class="flex items-center gap-2">
                            <input type="range" name="progress" min="0" max="100" value="<?php echo e($chantier->progress); ?>" 
                                   onchange="this.nextElementSibling.value = this.value; this.form.submit()"
                                   class="flex-1">
                            <input type="number" value="<?php echo e($chantier->progress); ?>" readonly 
                                   class="w-16 text-center font-bold text-lg" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;">
                ...
                <div class="bg-white border-2 rounded-lg p-4">
                    ...
                    <form method="POST" action="<?php echo e(route('chantiers.update-dates', $chantier)); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="space-y-2">
                            <input type="date" name="date_debut" value="<?php echo e($chantier->date_debut?->format('Y-m-d')); ?>" 
                                   placeholder="Début" class="w-full text-xs border rounded px-2 py-1">
                            <input type="date" name="date_fin_prevue" value="<?php echo e($chantier->date_fin_prevue?->format('Y-m-d')); ?>" 
                                   placeholder="Fin prévue" class="w-full text-xs border rounded px-2 py-1">
                            <input type="date" name="date_fin_reelle" value="<?php echo e($chantier->date_fin_reelle?->format('Y-m-d')); ?>" 
                ...
                <div class="bg-white border-2 rounded-lg p-4">
                    ...
                    <form method="POST" action="<?php echo e(route('chantiers.update-notes', $chantier)); ?>">
                        <?php echo csrf_field(); ?>
                        <textarea name="notes" rows="4" placeholder="Notes..." 
                                  class="w-full text-xs border rounded px-2 py-1 mb-2"><?php echo e($chantier->notes); ?></textarea>
    ...
    <div class="card-modern">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex justify-between items-center">
                <h3 class="text-lg font-bold text-gray-900">
                    <i class="fas fa-tasks mr-2" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;"></i>
                    Tâches
                </h3>
        ...
        <div class="p-6">
            <div class="space-y-4">
                <?php $__currentLoopData = $chantier->taches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tache): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white border-2 rounded-lg p-4 hover:shadow-md transition-shadow">
                    <div class="flex justify-between items-start mb-3">
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                <h4 class="font-bold text-gray-900 text-lg"><?php echo e($tache->nom); ?></h4>
                                <span class="px-2 py-1 text-xs rounded font-semibold <?php echo e($tache->status == 'termine' ? 'bg-green-100 text-green-800' : ($tache->status == 'en_cours' ? 'bg-blue-100 text-blue-800' : ($tache->status == 'bloque' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800'))); ?>">
                            ...
                            <p class="text-sm text-gray-600 mt-1 mb-2"><?php echo e($tache->description); ?></p>
                            <?php endif; ?>
                            <div class="flex items-center gap-4 mt-2 text-xs text-gray-500">
                                <span><i class="fas fa-users mr-1"></i><?php echo e($tache->techniciens->count()); ?> technicien(s)</span>
                                <?php if($tache->date_debut_prevue): ?>
                                <span><i class="fas fa-calendar mr-1"></i>Début: <?php echo e($tache->date_debut_prevue->format('d/m/Y')); ?></span>
                                <?php endif; ?>
                                <?php if($tache->date_fin_prevue): ?>
                                <span><i class="fas fa-calendar-check mr-1"></i>Fin: <?php echo e($tache->date_fin_prevue->format('d/m/Y')); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="flex items-center gap-2">
                            <button onclick="openModalEditTache(<?php echo e($tache->id); ?>)" 
                                    class="text-blue-600 hover:text-blue-800 p-2 rounded hover:bg-blue-50" 
                                    title="Modifier"
                                    data-tache-nom="<?php echo e($tache->nom); ?>"
                                    data-tache-description="<?php echo e($tache->description ?? ''); ?>"
                                    data-tache-type="<?php echo e($tache->type); ?>"
                                    data-tache-status="<?php echo e($tache->status); ?>"
                                    data-tache-progress="<?php echo e($tache->progress); ?>"
                                    data-tache-ordre="<?php echo e($tache->ordre); ?>"
                                    data-tache-date-debut="<?php echo e($tache->date_debut_prevue?->format('Y-m-d') ?? ''); ?>"
                                    data-tache-date-fin="<?php echo e($tache->date_fin_prevue?->format('Y-m-d') ?? ''); ?>">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form method="POST" action="<?php echo e(route('chantiers.taches.destroy', [$chantier, $tache])); ?>" 
                                  class="inline" 
                    ...
                    <div class="mb-3">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <form method="POST" action="<?php echo e(route('chantiers.taches.update', [$chantier, $tache])); ?>" class="flex items-center gap-2 flex-1">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="nom" value="<?php echo e($tache->nom); ?>">
                                <input type="hidden" name="description" value="<?php echo e($tache->description); ?>">
                                <input type="hidden" name="type" value="<?php echo e($tache->type); ?>">
                                <input type="hidden" name="status" value="<?php echo e($tache->status); ?>">
                                <input type="range" name="progress" min="0" max="100" value="<?php echo e($tache->progress); ?>" 
                                       onchange="this.nextElementSibling.value = this.value; this.form.submit()"
                                       class="flex-1">
                                <input type="number" value="<?php echo e($tache->progress); ?>" readonly 
                                       class="w-16 text-center font-bold text-sm" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;">
                    ...
                    <!-- Statut de la tâche -->
                    <div class="mb-3">
                        <form method="POST" action="<?php echo e(route('chantiers.taches.update', [$chantier, $tache])); ?>" class="flex items-center gap-2">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="nom" value="<?php echo e($tache->nom); ?>">
                            <input type="hidden" name="description" value="<?php echo e($tache->description); ?>">
                            <input type="hidden" name="type" value="<?php echo e($tache->type); ?>">
                    ...
                    <div class="border-t pt-3">
                        ...
                        <form method="POST" action="<?php echo e(route('chantiers.taches.assign-techniciens', [$chantier, $tache])); ?>" class="flex items-center gap-2">
                            <?php echo csrf_field(); ?>
                            <select name="techniciens[]" multiple 
                                ...
                                <?php $__currentLoopData = $techniciens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tech->id); ?>" <?php echo e($tache->techniciens->contains($tech->id) ? 'selected' : ''); ?>>
                        ...
                        <?php if($tache->techniciens->count() > 0): ?>
                        <div class="mt-2 flex flex-wrap gap-2">
                            <?php $__currentLoopData = $tache->techniciens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="px-2 py-1 text-xs rounded-full bg-blue-100 text-blue-800">
                                <i class="fas fa-user mr-1"></i><?php echo e($tech->name); ?>
    ...
    <div class="card-modern">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex justify-between items-center">
                <h3 class="text-lg font-bold text-gray-900">
                    <i class="fas fa-boxes mr-2" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;"></i>
        ...
        <div class="p-6 overflow-x-auto">
            <?php if($chantier->materiaux->count() > 0): ?>
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__currentLoopData = $chantier->materiaux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materiau): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 text-sm font-semibold text-gray-900"><?php echo e($materiau->nom_materiau); ?></td>
                        <td class="px-4 py-3 text-sm text-center text-gray-600"><?php echo e($materiau->unite); ?></td>
                        <td class="px-4 py-3 text-sm text-center font-bold text-gray-900"><?php echo e(number_format($materiau->quantite_prevue, 3, ',', ' ')); ?></td>
                        <td class="px-4 py-3 text-sm text-center font-bold text-gray-900"><?php echo e(number_format($materiau->quantite_utilisee, 3, ',', ' ')); ?></td>
                        <td class="px-4 py-3 text-sm text-center font-bold <?php echo e($materiau->difference >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                            <?php echo e(number_format($materiau->difference, 3, ',', ' ')); ?>

                        </td>
                        <td class="px-4 py-3 text-sm text-center font-bold"><?php echo e(number_format($materiau->difference_percent, 1, ',', ' ')); ?>%</td>
                        <td class="px-4 py-3 text-center">
                            <button onclick="openModalEditMateriau(<?php echo e($materiau->id); ?>, '<?php echo e($materiau->nom_materiau); ?>', '<?php echo e($materiau->unite); ?>', <?php echo e($materiau->quantite_prevue); ?>, <?php echo e($materiau->quantite_utilisee); ?>, '<?php echo e($materiau->notes ?? ''); ?>')" 
                                    class="text-blue-600 hover:text-blue-800 mr-2 p-2 rounded hover:bg-blue-50" title="Modifier">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form method="POST" action="<?php echo e(route('chantiers.materiaux.destroy', [$chantier, $materiau])); ?>" 
                                  class="inline" 
    ...
    <div class="card-modern">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex justify-between items-center">
                <h3 class="text-lg font-bold text-gray-900">
                    <i class="fas fa-camera mr-2" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;"></i>
                    Photos du Chantier
                </h3>
                <form method="POST" action="<?php echo e(route('chantiers.photos.store', $chantier)); ?>" enctype="multipart/form-data" class="flex items-center gap-2">
                    <?php echo csrf_field(); ?>
        ...
        <div class="p-6">
            <?php if($chantier->photos->count() > 0): ?>
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <?php $__currentLoopData = $chantier->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white border-2 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                    <img src="<?php echo e(Storage::url($photo->chemin_fichier)); ?>" alt="Photo chantier" class="w-full h-48 object-cover">
                    <div class="p-3">
                        <p class="text-xs text-gray-600 mb-2"><?php echo e($photo->commentaire); ?></p>
                        <p class="text-xs text-gray-400 mb-2">Par <?php echo e($photo->uploader->name ?? 'N/A'); ?></p>
                        <div class="flex gap-2">
                            <button onclick="openModalEditPhoto(<?php echo e($photo->id); ?>, '<?php echo e($photo->commentaire ?? ''); ?>')" 
                                    class="text-blue-600 hover:text-blue-800 text-xs p-1 rounded hover:bg-blue-50">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form method="POST" action="<?php echo e(route('chantiers.photos.destroy', [$chantier, $photo])); ?>" 
                                  class="inline" 
...
function openModalTache() {
    ...
    document.getElementById('form-tache').action = '<?php echo e(route("chantiers.taches.store", $chantier)); ?>';
...
function openModalEditTache(tacheId) {
    ...
    form.action = '<?php echo e(route("chantiers.taches.update", [$chantier, ":id"])); ?>'.replace(':id', tacheId);
...
function openModalMateriau() {
    ...
    form.action = '<?php echo e(route("chantiers.materiaux.store", $chantier)); ?>';
...
function openModalEditMateriau(id, nom, unite, prevue, utilisee, notes) {
    ...
    const form = document.getElementById('form-materiau');
    modal.classList.remove('hidden');
    form.action = '<?php echo e(route("chantiers.materiaux.update", [$chantier, ":id"])); ?>'.replace(':id', id);
...
function openModalEditPhoto(id, commentaire) {
    ...
    modal.classList.remove('hidden');
    form.action = '<?php echo e(route("chantiers.photos.update", [$chantier, ":id"])); ?>'.replace(':id', id);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gdevis\resources\views/chantiers/show.blade.php ENDPATH**/ ?>