...
<div class="space-y-6">
    ...
    <div class="card-modern overflow-hidden">
        <div class="px-6 py-6 border-b border-gray-200 bg-gradient-to-r" 
            ...
            <div class="mb-3 text-center">
                ...
                <p class="text-sm sm:text-base lg:text-lg text-gray-600 italic">
            ...
            <div class="flex items-center mt-4 pt-4 border-t border-gray-200">
                ...
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-gray-600">Vue d'ensemble de votre activité</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-modern p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($totalQuotes, 0, ',', ' ')); ?></p>
                    <p class="text-xs text-gray-500 mt-1">
                        <i class="fas fa-calendar-alt mr-1"></i><?php echo e($quotesThisMonth); ?> ce mois
                    </p>
                </div>
                <div class="p-4 rounded-xl" style="background: linear-gradient(135deg, <?php echo e($settings->primary_color ?? '#3b82f6'); ?> 0%, <?php echo e($settings->secondary_color ?? '#1e40af'); ?> 100%);">
        ...
        <div class="card-modern p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($totalClients, 0, ',', ' ')); ?></p>
                    <p class="text-xs text-gray-500 mt-1">
        ...
        <div class="card-modern p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($totalProducts, 0, ',', ' ')); ?></p>
                    <p class="text-xs text-gray-500 mt-1">
        ...
        <div class="card-modern p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($totalPayments, 0, ',', ' ')); ?></p>
                    <p class="text-xs text-gray-500 mt-1">
                        <i class="fas fa-money-bill-wave mr-1"></i><?php echo e(number_format($paymentsThisMonth, 0, ',', ' ')); ?> GNF ce mois
                    </p>
                </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4">
        ...
        <div class="card-modern p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <i class="fas fa-file-invoice-dollar text-xl" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;"></i>
            </div>
            <p class="text-xl sm:text-2xl font-bold whitespace-nowrap" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;">
                <?php echo e(number_format($totalQuotesAmount, 0, ',', ' ')); ?> <span class="text-sm">GNF</span>
            </p>
        </div>
        ...
        <div class="card-modern p-6">
            ...
            <p class="text-xl sm:text-2xl font-bold text-emerald-600 whitespace-nowrap">
                <?php echo e(number_format($totalValidatedQuotesAmount ?? 0, 0, ',', ' ')); ?> <span class="text-sm">GNF</span>
            </p>
        </div>
        ...
        <div class="card-modern p-6">
            ...
            <p class="text-xl sm:text-2xl font-bold text-green-600 whitespace-nowrap">
                <?php echo e(number_format($totalPaidAmount, 0, ',', ' ')); ?> <span class="text-sm">GNF</span>
            </p>
        </div>
            ...
            <div class="card-modern p-6 bg-gradient-to-r from-orange-50 to-red-50 border-2 border-orange-200 hover:shadow-lg transition-all duration-200 transform hover:scale-105 cursor-pointer">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="w-10 h-10 rounded-full flex items-center justify-center" 
                        ...
                        <i class="fas fa-wallet text-lg" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;"></i>
                    </div>
                </div>
                <p class="text-xl sm:text-2xl font-bold mb-2 whitespace-nowrap" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;">
                    <?php echo e(number_format($totalRemainingAmount ?? 0, 0, ',', ' ')); ?> <span class="text-sm">GNF</span>
                </p>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="card-modern overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                <h3 class="text-lg font-bold text-gray-900 flex items-center">
                    <i class="fas fa-chart-pie mr-2" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;"></i>
                    Devis par Statut
                </h3>
            </div>
            <div class="p-6">
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-lg font-bold text-gray-900"><?php echo e($quotesByStatus['draft']); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                        ...
                        <span class="text-lg font-bold text-gray-900"><?php echo e($quotesByStatus['sent']); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                        ...
                        <span class="text-lg font-bold text-gray-900"><?php echo e($quotesByStatus['accepted']); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                        ...
                        <span class="text-lg font-bold text-gray-900"><?php echo e($quotesByStatus['validated']); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                        ...
                        <span class="text-lg font-bold text-gray-900"><?php echo e($quotesByStatus['rejected']); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-modern overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                <h3 class="text-lg font-bold text-gray-900 flex items-center">
                    <i class="fas fa-trophy mr-2" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;"></i>
                    Top Clients
                </h3>
            </div>
            <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-gray-900"><?php echo e($client->name); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($client->quotes_count); ?> devis</p>
                            </div>
                        </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="card-modern overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('quotes.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800">
                        Voir tout <i class="fas fa-arrow-right ml-1"></i>
                    </a>
                </div>
            </div>
            <div class="overflow-x-auto">
                <?php if($recentQuotes->count() > 0): ?>
                        ...
                        <tr class="table-row-hover">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-900"><?php echo e($quote->quote_number); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($quote->client->name); ?></p>
                                    </div>
                                </div>
                            </td>
        ...
        <div class="card-modern overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-bold text-gray-900 flex items-center">
                        <i class="fas fa-money-bill-wave mr-2" style="color: <?php echo e($settings->primary_color ?? '#3b82f6'); ?>;"></i>
                        Paiements Récents
                    </h3>
                    <a href="<?php echo e(route('payments.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800">
                        Voir tout <i class="fas fa-arrow-right ml-1"></i>
                    </a>
                </div>
            </div>
                        ...
                        <tr class="table-row-hover">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-900"><?php echo e($payment->quote->quote_number); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($payment->quote->client->name); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <p class="text-sm font-bold text-green-600"><?php echo e(number_format($payment->amount, 0, ',', ' ')); ?> GNF</p>
                                <p class="text-xs text-gray-500"><?php echo e($payment->payment_date->format('d/m/Y')); ?></p>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gdevis\resources\views/dashboard/index.blade.php ENDPATH**/ ?>