...
<div class="max-w-4xl mx-auto">
    <div class="card-modern overflow-hidden">
        <div class="px-6 py-6 border-b border-gray-200 bg-gradient-to-r" 
            ...
            <p class="mt-2 text-sm text-gray-600">Ajoutez un nouveau client à votre base de données</p>
        </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}"
                        class="block w-full rounded-lg border-2 border-gray-300 bg-white px-4 py-2.5 text-gray-900 shadow-sm focus:ring-2 focus:border-transparent transition-all @error('email') border-red-400 bg-red-50 @enderror"
                        style="focus:ring-color: {{ $settings->primary_color ?? '#3b82f6' }};"
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" value="{{ old('phone') }}"
                        class="block w-full rounded-lg border-2 border-gray-400 bg-white px-4 py-3 text-gray-900 text-base shadow-sm focus:ring-2 focus:border-transparent transition-all @error('phone') border-red-500 bg-red-50 @enderror"
                        style="focus:ring-color: {{ $settings->primary_color ?? '#3b82f6' }};"
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="address" id="address" value="{{ old('address') }}"
                        class="block w-full rounded-lg border-2 border-gray-400 bg-white px-4 py-3 text-gray-900 text-base shadow-sm focus:ring-2 focus:border-transparent transition-all @error('address') border-red-500 bg-red-50 @enderror"
                        style="focus:ring-color: {{ $settings->primary_color ?? '#3b82f6' }};"
                ...
                <div>
                    ...
                    <input type="text" name="postal_code" id="postal_code" value="{{ old('postal_code') }}"
                        class="block w-full rounded-lg border-2 border-gray-400 bg-white px-4 py-3 text-gray-900 text-base shadow-sm focus:ring-2 focus:border-transparent transition-all @error('postal_code') border-red-500 bg-red-50 @enderror"
                        style="focus:ring-color: {{ $settings->primary_color ?? '#3b82f6' }};"
                        placeholder="00000">
                    @error('postal_code')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="text" name="city" id="city" value="{{ old('city') }}"
                        class="block w-full rounded-lg border-2 border-gray-400 bg-white px-4 py-3 text-gray-900 text-base shadow-sm focus:ring-2 focus:border-transparent transition-all @error('city') border-red-500 bg-red-50 @enderror"
                        style="focus:ring-color: {{ $settings->primary_color ?? '#3b82f6' }};"
                        placeholder="Conakry">
                    @error('city')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="text" name="country" id="country" value="{{ old('country', 'Guinée') }}"
                        class="block w-full rounded-lg border-2 border-gray-400 bg-white px-4 py-3 text-gray-900 text-base shadow-sm focus:ring-2 focus:border-transparent transition-all @error('country') border-red-500 bg-red-50 @enderror"
                        style="focus:ring-color: {{ $settings->primary_color ?? '#3b82f6' }};"
                        placeholder="Guinée">
                    @error('country')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
