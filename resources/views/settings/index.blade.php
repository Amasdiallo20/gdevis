            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="activity" id="activity" value="{{ old('activity', $settings->activity) }}"
                            class="block w-full rounded-lg border-2 border-gray-400 bg-white px-4 py-3 text-gray-900 text-base shadow-sm focus:ring-2 focus:border-transparent transition-all"
                            style="focus:ring-color: {{ $settings->primary_color ?? '#3b82f6' }};">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="rccm" id="rccm" value="{{ old('rccm', $settings->rccm) }}"
                            class="block w-full rounded-lg border-2 border-gray-400 bg-white px-4 py-3 text-gray-900 text-base shadow-sm focus:ring-2 focus:border-transparent transition-all"
                            style="focus:ring-color: {{ $settings->primary_color ?? '#3b82f6' }};">
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="address" id="address" rows="3"
                            ...
                            style="focus:ring-color: {{ $settings->primary_color ?? '#3b82f6' }};">{{ old('address', $settings->address) }}</textarea>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        @if($settings->logo)
                            <div class="mt-2 mb-4">
                                ...
                                <p class="text-sm text-red-500 mt-2" style="display:none;">Logo non trouvé: {{ $settings->logo }}</p>
                                <p class="text-sm text-gray-500 mt-2">Logo actuel (chemin: {{ $settings->logo }})</p>
                            </div>
                        @endif
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <input type="color" name="secondary_color" id="secondary_color" value="{{ old('secondary_color', $settings->secondary_color ?? '#1e40af') }}"
                                class="h-10 w-20 rounded border-gray-300 cursor-pointer">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <input type="color" name="print_header_color" id="print_header_color" value="{{ old('print_header_color', $settings->print_header_color ?? '#14b8a6') }}"
                                class="h-10 w-20 rounded border-gray-300 cursor-pointer">
                            <input type="text" value="{{ old('print_header_color', $settings->print_header_color ?? '#14b8a6') }}" 
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <input type="color" name="print_text_color" id="print_text_color" value="{{ old('print_text_color', $settings->print_text_color ?? '#ffffff') }}"
                                class="h-10 w-20 rounded border-gray-300 cursor-pointer">
                            <input type="text" value="{{ old('print_text_color', $settings->print_text_color ?? '#ffffff') }}" 
