        ...
        <form action="{{ route('materials.store') }}" method="POST" class="p-6">
            ...
            <div class="mt-6">
                ...
                <select name="unite" id="unite" required
                    ...
                    <option value="barre" {{ old('unite', 'barre') == 'barre' ? 'selected' : '' }}>barre</option>
                    <option value="m" {{ old('unite') == 'm' ? 'selected' : '' }}>m (mètre)</option>
                    <option value="Paire" {{ old('unite') == 'Paire' ? 'selected' : '' }}>Paire</option>
                    ...
                    <option value="kg" {{ old('unite') == 'kg' ? 'selected' : '' }}>kg (kilogramme)</option>
                    <option value="__custom__">Autre (saisie libre)</option>
                </select>
                <input type="text" name="unite_custom" id="unite_custom" value="{{ old('unite') }}" 
